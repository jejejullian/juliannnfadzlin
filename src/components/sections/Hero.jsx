...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center px-5 md:px-[60px] overflow-hidden bg-cover bg-bottom bg-no-repeat" style={{ backgroundImage: `url(${bgHero})` }}>
      <div className="mt-20">
        ...
        <div className="flex justify-center">
          <a href="https://www.linkedin.com/in/juliannurfadzlin" target="_blank" className="px-6 py-2 text-[16px] md:text-xl text-slate-50 border border-slate-50 bg-transparent/0 backdrop-blur-[2px] rounded-full cursor-pointer transition-colors duration-300 ease-out hover:bg-white/20 ">
            More About Me
          </a>
        </div>
      </div>
