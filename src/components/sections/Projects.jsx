                    ...
                    <div className="mt-8 md:mt-10">
                      {project.link ? (
                        <a
                          ...
                          style={{
                            borderColor: isDark ? "rgba(237,237,237,0.3)" : "rgba(10,10,10,0.2)",
                            color: theme.text,
                            backgroundColor: isDark ? "rgba(255,255,255,0.04)" : "rgba(0,0,0,0.03)",
                          }}
                          onMouseEnter={(e) => {
                            e.currentTarget.style.backgroundColor = isDark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.08)";
                            e.currentTarget.style.borderColor = isDark ? "rgba(237,237,237,0.6)" : "rgba(10,10,10,0.4)";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.backgroundColor = isDark ? "rgba(255,255,255,0.04)" : "rgba(0,0,0,0.03)";
                            e.currentTarget.style.borderColor = isDark ? "rgba(237,237,237,0.3)" : "rgba(10,10,10,0.2)";
                          }}
                        >
                          View Project
