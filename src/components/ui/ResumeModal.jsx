...
import { MdOutlineWorkOutline, MdOutlineCode } from "react-icons/md";
        ...
        <div className="px-6 md:px-8 py-6 space-y-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <MdOutlineWorkOutline size={24} className="text-neutral-950" />
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <MdOutlineCode size={24} className="text-neutral-950" />
